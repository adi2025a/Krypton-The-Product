...
export default function AuthPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      sessionStorage.setItem("krypton_email", email);
      const onboarding = await refreshOnboarding();
      if (onboarding?.llm_key_set) {
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] bg-card border-r border-border p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="font-['Rajdhani'] text-2xl font-bold tracking-widest text-foreground uppercase">
              KRYPTON
            </span>
          </div>
        ...
        <div className="relative z-10 space-y-8">
          {[
            ...
            <div key={f.title} className="flex gap-4">
              ...
              <div>
                <div className="font-['Rajdhani'] text-base font-semibold text-foreground">{f.title}</div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="flex lg:hidden items-center gap-3 mb-10 justify-center">
            ...
            <span className="font-['Rajdhani'] text-2xl font-bold tracking-widest text-foreground uppercase">KRYPTON</span>
          </div>
          ...
          <AnimatePresence mode="wait">
            {view === "login" && (
              <motion.div key="login" variants={pageVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.25 }}>
                <div className="mb-8">
                  <h1 className="text-3xl font-['Rajdhani'] font-bold text-foreground mb-1">Welcome back</h1>
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-primary text-primary-foreground rounded-lg py-3 font-['Rajdhani'] font-bold text-base tracking-widest uppercase hover:bg-primary/90 active:scale-[0.99] transition-all disabled:opacity-60 flex items-center justify-center gap-2 mt-2"
                  >
                    {loading ? (
            ...
            {view === "signup" && (
              <motion.div key="signup" variants={pageVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.25 }}>
                <div className="mb-8">
                  <h1 className="text-3xl font-['Rajdhani'] font-bold text-foreground mb-1">Create account</h1>
            ...
            {view === "otp" && (
              <motion.div key="otp" variants={pageVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.25 }}>
                <div className="mb-8 text-center">
                  ...
                  <h1 className="text-3xl font-['Rajdhani'] font-bold text-foreground mb-1">Verify Email</h1>
                ...
                >
                  <div className="flex gap-3 justify-center mb-6" onPaste={handleOTPPaste}>
                    {otp.map((digit, i) => (
                      <input
                        ...
                        className="w-12 h-14 text-center text-xl font-mono bg-secondary border border-border rounded-lg text-foreground focus:outline-none focus:border-primary/60 focus:ring-1 focus:ring-primary/30 transition-all"
                  ...
                  <button
                    ...
                    className="w-full bg-primary text-primary-foreground rounded-lg py-3 font-['Rajdhani'] font-bold text-base tracking-widest uppercase hover:bg-primary/90 active:scale-[0.99] transition-all disabled:opacity-60 flex items-center justify-center gap-2"
                  >
